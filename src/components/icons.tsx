...
export function PeopleIcon(props: IconProps) {
  return (
    ...
    >
      ...
      <path d="M16.2 19a4.8 4.8 0 0 1 5.3-4.4" />
    </svg>
  )
}
...
export function EyeOffIcon(props: IconProps) {
  return (
    ...
    >
      ...
      <path d="M9.9 5.1A10.8 10.8 0 0 1 12 5c6.5 0 10 7 10 7a17.4 17.4 0 0 1-4.2 5.1" />
      <path d="M6.1 6.1A17.5 17.5 0 0 0 2 12s3.5 7 10 7a10.7 10.7 0 0 0 4.4-.9" />
    </svg>
  )
}
...
export function ExitLeftIcon(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function ExitRightIcon(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function AddStudentIcon(props: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function AddClassIcon(props: IconProps) {
  return <ClassIcon {...props} />
}

export function ManageBusesIcon(props: IconProps) {
