        ...
        className={
          compact
            ? onDark
              ...
              : 'h-5 w-5 animate-spin rounded-full border-2 border-gray-200 border-t-teal-500'
            : 'h-10 w-10 animate-spin rounded-full border-4 border-gray-200 border-t-teal-500'
        }
      />
      <span
        className={
...
export function ConnectionError() {
  return (
    <p className="mt-12 px-4 text-center text-red-600" role="alert">
